function [dAAindt]=ElectroSym_function(AAex,AAin,Kmex,Kmin,rVmax,Vmax,KmNaex,KmNain,KmHin,KmHex,Naex,Nain,Hyex,Hyin,dt,Vol)
...
% Total flux
Jtoi=(Vmax*Ftex*(Naex/(KmNaex+Naex))*(Hyin/(KmHin+Hyin)))*dt;
Jtio=(Vmax*Ftin*(Nain/(KmNain+Nain))*(Hyex/(KmHex+Hyex)))*dt;
