function [dAAindt]=ProtonSym_function(AAex,AAin,Kmex,Kmin,rVmax,Vmax,KmHin,KmHex,Hyex,Hyin,dt,Vol,B)
...
% Total flux
Jtoi=Vmax*Ftex*(Hyex/(KmHex+Hyex))*B*(1-Ftin)*(KmHin/(KmHin+Hyin))*dt;
Jtio=Vmax*Ftin*(Hyin/(KmHin+Hyin))*(1/B)*(1-Ftex)*(KmHex/(KmHex+Hyex))*dt;
