function [dAAindt]=NaSym_function(AAex,AAin,Kmex,Kmin,rVmax,Vmax,NaKmex,NaKmin,Naex,Nain,dt,Vol,B)
...
% Total flux
Jtoi=(Vmax*(Ftex*(Naex/(NaKmex+Naex)))*(B*(1-Ftin)*(NaKmin/(NaKmin+Nain))))*dt;
Jtio=(Vmax*(Ftin*(Nain/(NaKmin+Nain)))*((1/B)*(1-Ftex)*(NaKmex/(NaKmex+Naex))))*dt;
